...
struct VehicleInfo: View {
    ...
    VStack {
                ...
                ScrollView(.horizontal){
                    HStack{
                        SelectButton(isSelected: $isSelected1, text: "4- cylinder engine", color: .green)
                            .onTapGesture {
                                isSelected1.toggle()
                                if  isSelected1{
                                    isSelected2=false
                        ...
                        SelectButton(isSelected: $isSelected2, text: "6- cylinder engine", color: .green)
                            .onTapGesture {
                                isSelected2.toggle()
                                if  isSelected2{
                                    isSelected1=false
                        ...
                        SelectButton(isSelected: $isSelected3, text: "8- cylinder engine", color: .green)
                            .onTapGesture {
                                isSelected3.toggle()
                                if  isSelected2{
                                    isSelected1=false
